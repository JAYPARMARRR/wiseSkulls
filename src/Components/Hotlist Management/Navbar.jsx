  ...
  return (
    <>
          ...
          <div ref={menuRef} className="popup" id="popupModal">
            <div className="modal-content">
              ...
              <h4 className="PowerOff-button">
                <span className="FaPowerOff" onClick={showDeleteCon}>
                  <FaPowerOff />
                </span>

                <span onClick={showDeleteCon} className="FaPowerOff-logout">
      ...
      <Modal
        open={DeleteCon}
        onOk={handleOk}
        onCancel={CancelDeleteCon}
        footer={null}
      
        className="DeleteCon-modal"
      >
