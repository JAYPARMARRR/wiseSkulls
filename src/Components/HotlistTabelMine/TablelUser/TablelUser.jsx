...
const TablelUser = () => {
  ...
  const [candidates, setCandidates] = useState([
    { id: 1, name: 'John Doe', title: 'Software Engineer', experience: '5 years', visaType: 'H1B', currentLocation: 'New York', relocation: 'Yes', availability: 'Immediate' },
    { id: 2, name: 'Jane Smith', title: 'Frontend Developer', experience: '3 years', visaType: 'Green Card', currentLocation: 'San Francisco', relocation: 'No', availability: '2 weeks' },
    { id: 3, name: 'Jane Smith', title: 'Frontend Developer', experience: '3 years', visaType: 'Green Card', currentLocation: 'San Francisco', relocation: 'No', availability: '2 weeks' },
    { id: 4, name: 'Jane Smith', title: 'Frontend Developer', experience: '3 years', visaType: 'Green Card', currentLocation: 'San Francisco', relocation: 'No', availability: '2 weeks' },
    { id: 5, name: 'Jane Smith', title: 'Frontend Developer', experience: '3 years', visaType: 'Green Card', currentLocation: 'San Francisco', relocation: 'No', availability: '2 weeks' },
    { id: 6, name: 'Jane Smith', title: 'Frontend Developer', experience: '3 years', visaType: 'Green Card', currentLocation: 'San Francisco', relocation: 'No', availability: '2 weeks' },
    { id: 7, name: 'Jane Smith', title: 'Frontend Developer', experience: '3 years', visaType: 'Green Card', currentLocation: 'San Francisco', relocation: 'No', availability: '2 weeks' },
    { id: 8, name: 'Jane Smith', title: 'Frontend Developer', experience: '3 years', visaType: 'Green Card', currentLocation: 'San Francisco', relocation: 'No', availability: '2 weeks' },
    { id: 9, name: 'Jane Smith', title: 'Frontend Developer', experience: '3 years', visaType: 'Green Card', currentLocation: 'San Francisco', relocation: 'No', availability: '2 weeks' },
